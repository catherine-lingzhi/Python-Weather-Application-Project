    ...
    def process_choice(self, choice):
        ...
        try:
            ...
            if choice == 1:
                ...
                print("Latest date string from database:", latest_date_str)

                latest_date = datetime.strptime(latest_date_str, "%Y-%m-%d").date()
                print("Converted latest date:", latest_date)    
                ...
                if latest_date <= end_date:
                    ...
                    print(f"Weather data updated for {latest_date}")                  

                print("Weather data update completed.")
            elif choice == 3:
